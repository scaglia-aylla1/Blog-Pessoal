...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/scaglia-aylla1/Blog-Pessoal) dentro da pasta do *Workspace* do STS
 
```bash
git clone https://github.com/scaglia-aylla1/Blog-Pessoal.git
```
